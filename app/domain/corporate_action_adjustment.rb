module CorporateActionAdjustment
  class << self
    ...
    def calculate_cumulative_adjustment_factor(security, observation_datestamp, adjustment_base_datestamp)
      ...
      if corporate_action_time_series_map
        ...
        #   }
        #   to_a
        corporate_actions = corporate_action_time_series_map.between(observation_datestamp, adjustment_base_datestamp, false, true).values
