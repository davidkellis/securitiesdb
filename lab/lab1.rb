...
class Lab1
  ...
  def run
    ...
    simple_predictive_variables = [
      ...
      Variables::AdjustedEodBarClose.new(google, 20160101).memoized(30),
      Variables::EodBarClose.new(microsoft).memoized(30),
      Variables::AdjustedEodBarClose.new(microsoft, 20160101).memoized(30),
      Variables::EodBarClose.new(exxon).memoized(30),
      Variables::AdjustedEodBarClose.new(exxon, 20160101).memoized(30),
      Variables::EodBarClose.new(ge).memoized(30),
      Variables::AdjustedEodBarClose.new(ge, 20160101).memoized(30)
    ]
